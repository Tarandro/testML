        ...
        if self.dimension_embedding == 'doc_embedding':
            ...
            if self.flags_parameters.tf_stop_words:
                if self.flags_parameters.language_text == 'fr':
                    ...
                    stopwords = en_stop
                # self.parameters['vect__tf__stop_words'] = [None, list(stopwords)]
                self.parameters['vect__tf__stop_words'] = hp.choice('vect__tf__stop_words', [None, list(stopwords)])
            else:
